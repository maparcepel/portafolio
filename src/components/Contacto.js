        ...
        <div className='d-flex contacto flex-column justify-content-cente'>
            ...
            <div className='container d-flex justify-content-center align-items-center'>
                ...
                <div className='contact-info'>
                    <h4><a className='animate__animated animate__flash' href="mailto:info@marcelmolina.net"><i className="fas fa-caret-right me-1"></i>marcelmolina.dev@gmail.com</a> </h4>
